...
var NguiAutoCompleteComponent = (function () {
            ...
            switch (evt.keyCode) {
                ...
                case 13:
                    if (_this.filteredList.length > 0) {
                        _this.selectOneWithSave(_this.filteredList[_this.itemIndex]);
                    }
                    evt.preventDefault();
                    break;
                case 9:
    ...
    ;
    NguiAutoCompleteComponent.prototype.selectOneWithSave = function (data) {
        var string = this.keyword + " " + data;
        this.valueSelected.emit(string);
    };
    ;
